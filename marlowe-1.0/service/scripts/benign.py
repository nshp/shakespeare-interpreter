...
with open('../src/include/titles.wordlist') as f:
    titles = [t.strip() for t in f.readlines()]

with open('../src/include/scenes.wordlist') as f:
    scenes = [s.strip() for s in f.readlines()]

with open('../src/include/character.wordlist') as f:
    names = [n.strip() for n in f.readlines()]

with open('../src/include/descriptions.wordlist') as f:
...
try:
    ...
    words = ['you','have','no','dictionary','therefore','thou','art','awful']
